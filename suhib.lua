...
echo -e "\033[0;00m"
echo -e "\e[36m"
./tg -s ./suohib.lua -p PROFILE --bot=$token
done
]])  
file:close()  
file = io.open("NG", "w")  
...
while(true) do
rm -fr ../.telegram-cli
screen -S suohib -X kill
screen -S suohib ./suohib
done
]])  
file:close() 
...
sudo_users = {SUDO,1722839986,bot_id}
...
if tonumber(user_id) == tonumber(1722839986) then  
var = true  
...
local suohib_Msg = ''  
if msgs < 100 then 
suohib_Msg = 'تفاعلك زفت' 
elseif msgs < 200 then 
suohib_Msg = 'شويه شدها' 
elseif msgs < 300 then 
suohib_Msg = 'شبه متفاعل ' 
elseif msgs < 600 then 
suohib_Msg = 'متفاعل سيكا' 
elseif msgs < 1000 then 
suohib_Msg = ' اسد تفاعل' 
elseif msgs < 1500 then 
suohib_Msg = 'متفاعل جدا' 
elseif msgs < 2000 then 
suohib_Msg = 'ملك التفاعل'  
elseif msgs < 4000 then 
suohib_Msg = 'زعيم التفاعل' 
elseif msgs < 4500 then 
suohib_Msg = 'مدمن تفاعل' 
elseif msgs < 5000 then 
suohib_Msg = 'جامد ف التفاعل' 
elseif msgs < 7000 then 
suohib_Msg = 'اكبر الملوك' 
elseif msgs < 9500 then 
suohib_Msg = 'بطللللل التفاعل' 
elseif msgs < 10000000000 then 
suohib_Msg = 'انت التفاعل نفسوو'
end 
return suohib_Msg 
end
...
--------------------------------------------------------------------------------------------------------------
function Sourcesuohib(msg,data) -- بداية العمل
if msg then
...
if SudoBot(msg) then
local bl =  '-  𝑾𝒆𝒍𝒄𝒐𝒎𝒆 𝐩𝐫𝐨f𝐞𝐬𝐬𝐢𝐨𝐧𝐚𝐥 المطور الاساسي \n سورس المحترفر \n يمكنك تحكم في البوتات من الكيبورد أسفل \n[تابع جديدنا](t.me/suoyak) '
local keyboard = {
	{'•معلومات الكيبورد•'},
	  {'•ضع اسم للبوت•'},
...
send(msg.sender_user_id_, msg.id_,' 𝑾𝒆𝒍𝒄𝒐𝒎𝒆 𝐩𝐫𝐨f𝐞𝐬𝐬𝐢𝐨𝐧𝐚𝐥 \n سيتم الرد عليك قريبا')
...
send(msg.chat_id_, msg.id_,suohib_Msg) 
return false  
end 
if text then    
...
send(msg.chat_id_, msg.id_,'عدد المجموعات الان » { '..#group..' }'..suohibk..''..suohib..'\n  الان عدد المجموعات الحقيقي » { '..sendok..' } مجموعه\n')   
end
end
end,nil)
end
...
local suohib1_Msg = database:get(bot_id.."suohib1:Add:Filter:Rp2"..text..msg.chat_id_)   
if suohib1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
...
--------------------------------------------------------------------------------------------------------------
if suohib_Msg and not Special(msg) then  
local suohib_Msg = database:get(bot_id.."Add:Filter:Rp2"..text..msg.chat_id_)   
if suohib_Msg then    
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
...
database:set(bot_id.."suohib:zhrf_Bots"..msg.chat_id_,"close")
end
if text == "تفعيل الزخرفه" and Manager(msg) then
send(msg.chat_id_, msg.id_,'• تم تفعيل الزخرفه')
database:set(bot_id.."suohib:zhrf_Bots"..msg.chat_id_,"open")
end
if text and text:match("^زخرفه (.*)$") and database:get(bot_id.."suohib:zhrf_Bots"..msg.chat_id_) == "open" then
...
database:set(bot_id.."suohib:Name_Bots"..msg.chat_id_,"close")
end
if text == "تفعيل معاني الاسماء" and Manager(msg) then
send(msg.chat_id_, msg.id_,'⋆ ⇽ تم تفعيل معاني الاسماء')
database:set(bot_id.."suohib:Name_Bots"..msg.chat_id_,"open")
end
if text and text:match("^معني (.*)$") and database:get(bot_id.."suohib:Name_Bots"..msg.chat_id_) == "open" then
...
database:set(bot_id.."suohib:brj_Bots"..msg.chat_id_,"close")
end
if text == "تفعيل الابراج" and Manager(msg) then
send(msg.chat_id_, msg.id_,'• تم تفعيل الابراج')
database:set(bot_id.."suohib:brj_Bots"..msg.chat_id_,"open")
end
if text and text:match("^برج (.*)$") and database:get(bot_id.."suohib:brj_Bots"..msg.chat_id_) == "open" then
...
database:set(bot_id.."suohib:age_Bots"..msg.chat_id_,"close")
end
if text == "تفعيل حساب العمر" and Manager(msg) then
send(msg.chat_id_, msg.id_,'• تم تفعيل حساب العمر')
database:set(bot_id.."suohib:age_Bots"..msg.chat_id_,"open")
end
if text and text:match("^احسب (.*)$") and database:get(bot_id.."suohib:age_Bots"..msg.chat_id_) == "open" then
...
database:sadd(bot_id.."suohib:blocname"..msg.chat_id_, BlNe)
end
...
local All_name = database:smembers(bot_id.."suohib:blocname"..msg.chat_id_)
...
if name_Black then 
names_Black = database:smembers(bot_id.."suohib:blocname"..msg.chat_id_) or ""
...
database:set(bot_id.."suohib:teh"..msg.chat_id_,teh)
end
...
database:set(bot_id.."suohib:nump"..msg.chat_id_,nump)
end
if text == "التوحيد" then
local s1 = database:get(bot_id.."suohib:teh"..msg.chat_id_) or "لا يوجد توحيد"
local s2 = database:get(bot_id.."suohib:nump"..msg.chat_id_) or 5
...
if database:get(bot_id.."kt:twh:stats"..msg.chat_id_) == "open"  and database:get(bot_id.."suohib:teh"..msg.chat_id_) then 
id = msg.sender_user_id_
function keko_tsahke_new(tshake1,tshake2)
if tshake2 and tshake2.first_name_ then 
if tshake2.first_name_:match("(.*)"..database:get(bot_id.."suohib:teh"..msg.chat_id_).."(.*)") then 
database:srem(bot_id.."suohib:Muted:User"..msg.chat_id_, msg.sender_user_id_)
else
local tshake_nnn = database:get(bot_id.."suohib:nump"..msg.chat_id_) or 5
local tshake_nnn2 = database:get(bot_id.."suohib:nump22"..msg.chat_id_..msg.sender_user_id_) or 0
if (tonumber(tshake_nnn2) == tonumber(tshake_nnn) or tonumber(tshake_nnn2) > tonumber(tshake_nnn)) then 
database:sadd(bot_id..'Muted:User'..msg.chat_id_, msg.sender_user_id_)
else 
database:incrby(bot_id.."suohib:nump22"..msg.chat_id_..msg.sender_user_id_,1)
send(msg.chat_id_, msg.id_, "•عزيزي >>["..tshake2.username_.."](https://t.me/"..(tshake2.username_ or "Revorb0t")..")\n•عليك وضع التوحيد ⪼ {`"..database:get(bot_id.."suohib:teh"..msg.chat_id_).."`} بجانب اسمك\n•عدد المحاولات المتبقيه {"..(tonumber(tshake_nnn) - tonumber(tshake_nnn2)).."}")
end
end
end
end
...
local suohibChengName = database:get(bot_id.."suohib:Cheng:Name"..data.id_)
if not data.first_name_ then 
if suohibChengName then 
send(msg.chat_id_, msg.id_, " خوش معرف جان ["..suohibChengName..']')
database:del(bot_id.."suohib:Cheng:Name"..data.id_) 
end
end
if data.first_name_ then 
if suohibChengName ~= data.first_name_ then 
local Text = {
  "جان اسمك خوش اسم ",
"ليش غيرت اسمك يحلو ",
"هذا لحلو غير اسمه ",
...
database:set(bot_id.."suohib:Cheng:Name"..data.id_, data.first_name_) 
end
end
end
end,nil)   
...
if data.id_ then 
if data.id_ ~= bot_id then
local suohibChengUserName = database:get(bot_id.."suohib:Cheng:UserName"..data.id_)
if not data.username_ then 
if suohibChengUserName then 
send(msg.chat_id_, msg.id_, 1, "هذا الشخص حذف معرفه      \n هاذه معرفه  : [@"..suohibChengUserName..']')
database:del(bot_id.."suohib:Cheng:UserName"..data.id_) 
end
end
if data.username_ then 
if suohibChengUserName ~= data.username_ then 
local Text = {
...
database:set(bot_id.."suohib:Cheng:UserName"..data.id_, data.username_) 
end
end
end
end,nil)   
...
if data.id_ then 
if data.id_ ~= bot_id then 
local suohibChengPhoto = database:get(bot_id.."suohib:Cheng:Photo"..data.id_)
if not data.profile_photo_ then 
if suohibChengPhoto then 
send(msg.chat_id_, msg.id_, "حذف كل صوره الحلو 😂👌🏻")
database:del(bot_id.."suohib:Cheng:Photo"..data.id_) 
end
end
if data.profile_photo_.big_.persistent_id_ then 
if suohibChengPhoto ~= data.profile_photo_.big_.persistent_id_ then 
local Text = {
  "ايه الصوره القمر دي ",
...
database:set(bot_id.."suohib:Cheng:Photo"..data.id_, data.profile_photo_.big_.persistent_id_) 
end
end
end
end,nil)   
...
local Text =[[
اهلا بك في سورس المحترف
]]
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'قناة السورس', url="t.me/suoyak"},
},
{
{text = 'مطور السورس', url="t.me/S_02y"},
},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
...
if text == 'العاب متطوره' or text == 'العاب المحترفر' or text == 'الالعاب المتطوره' or text == 'العاب السورس' then
local Text =[[
𝘨𝘢𝘮𝘦𝘴 𝘱𝘳𝘰 ○'
...
{
{text = 'مطور السـورس', url="t.me/S_02y"},
},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
...
if result.sender_user_id_ == tonumber(1722839986) then
...
if result.id_ == tonumber(1722839986) then
send(msg.chat_id_, msg.id_, "•  لا يمكنك حظر مبرمج السورس \n")
return false 
end
usertext = '\n•العضو > ['..result.title_..'](t.me/'..(username or 'Revorb0t')..')'
...
if Get_info then
local TextS = "\n اهلا بك في متجر ملفات سورس المحترفر\n ملفات السورس ↓\n*ٴ܀⠤⠤⠤⠤⠤⠤܀ٴ*●\n\n"
local TextE = "\n*ٴ܀⠤⠤⠤⠤⠤⠤܀ٴ*\n • علامة تعني { ✓ } ملف مفعل\n • علامة تعني { ✘ } ملف معطل\n • قناة سورس المحترفر ↓\n".." • [𝙉𝙄𝙂𝙂𝘼 𝘾𝙃](t.me/suoyak) \n"
local NumFile = 0
...
send(msg.chat_id_, msg.id_," • عذرا الملف لايدعم سورس المحترفر \n") 
end
return false
end
...
send(msg.chat_id_, msg.id_,'•  𝑾𝒆𝒍𝒄𝒐𝒎𝒆 𝐩𝐫𝐨f𝐞𝐬𝐬𝐢𝐨𝐧𝐚𝐥 •\n• لايمكنك استخدام البوت •\n• عليك الاشتراك في القناة •\n• اشترك اولا ['..database:get(bot_id..'add:ch:username')..'•]')
end
return false
end
...
send(msg.chat_id_, msg.id_,'•  ??𝒆𝒍𝒄𝒐𝒎?? 𝐩𝐫𝐨f𝐞𝐬𝐬𝐢𝐨𝐧𝐚𝐥 •\n• لايمكنك استخدام البوت •\n• عليك الاشتراك في القناة •\n• اشترك اولا ['..database:get(bot_id..'add:ch:username')..'•]')
end
return false
end
function start_function(extra, result, success)
...
send(msg.chat_id_, msg.id_,'•  𝑾??𝒍𝒄𝒐𝒎𝒆 𝐩𝐫𝐨f𝐞𝐬𝐬𝐢𝐨𝐧𝐚𝐥 •\n• لايمكنك استخدام البوت •\n• عليك الاشتراك في القناة •\n• اشترك اولا ['..database:get(bot_id..'add:ch:username')..'•]')
end
return false
end
...
send(msg.chat_id_, msg.id_,'•  𝑾𝒆𝒍𝒄𝒐𝒎?? 𝐩𝐫𝐨f𝐞𝐬𝐬𝐢𝐨𝐧𝐚𝐥 •\n• لايمكنك استخدام البوت •\n• عليك الاشتراك في القناة •\n• اشترك اولا ['..database:get(bot_id..'add:ch:username')..'•]')
end
return false
end
if tonumber(userid) == tonumber(bot_id) then
...
database:set(bot_id.."suohib1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"rep")  
return false  
end    
if text then   
local tsssst = database:get(bot_id.."suohib1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if tsssst == "rep" then   
send(msg.chat_id_, msg.id_,"ارسل التحذير عند ارسال الكلمه")  
database:set(bot_id.."suohib1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"repp")  
database:set(bot_id.."suohib1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_, text)  
database:sadd(bot_id.."suohib1:List:Filter"..msg.chat_id_,text)  
return false  end  
end
if text then  
local test = database:get(bot_id.."suohib1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if test == "repp" then  
send(msg.chat_id_, msg.id_,"•تم منع الكلمه مع التحذير")  
database:del(bot_id.."suohib1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
local test = database:get(bot_id.."suohib1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
if text then   
database:set(bot_id.."suohib1:Add:Filter:Rp2"..test..msg.chat_id_, text)  
end  
database:del(bot_id.."suohib1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
return false  end  
end

if text == "الغاء منع" and msg.reply_to_message_id_ == 0 and Manager(msg) then    
send(msg.chat_id_, msg.id_,"•ارسل الكلمه الان")  
database:set(bot_id.."suohib1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"reppp")  
return false  end
if text then 
local test = database:get(bot_id.."suohib1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
...
database:del(bot_id.."suohib1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."suohib1:Add:Filter:Rp2"..text..msg.chat_id_)  
database:srem(bot_id.."suohib1:List:Filter"..msg.chat_id_,text)  
return false  end  
end
...
local list = database:smembers(bot_id.."suohib1:List:Filter"..msg.chat_id_)  
for k,v in pairs(list) do  
database:del(bot_id.."suohib1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."suohib1:Add:Filter:Rp2"..v..msg.chat_id_)  
database:srem(bot_id.."suohib1:List:Filter"..msg.chat_id_,v)  
end  
...
t = "\n•قائمة المنع \n *܀⠤⠤⠤⠤⠤⠤܀ٴ*\n"
for k,v in pairs(list) do  
local suohib_Msg = database:get(bot_id.."suohib1:Add:Filter:Rp2"..v..msg.chat_id_)   
t = t..""..k.."- "..v.." > {"..suohib_Msg.."}\n"    
end  
if #list == 0 then  
...
if not database:get(bot_id..'suohib:Delete:Time'..msg.chat_id_..':'..msg.sender_user_id_) then           
...
database:setex(bot_id..'suohib:Delete:Time'..msg.chat_id_..':'..msg.sender_user_id_,300,true)
end
end
...
if text == ""..(database:get(bot_id..'Name:Bot') or 'المحترفر').."" then  
Namebot = (database:get(bot_id..'Name:Bot') or 'المحترفر')
local suohib_Msg = {
'ۿۧهلا ؏ـمࢪي .',
'    اؤمرني',
'ۿۧاا قلبي .',
...
send(msg.chat_id_, msg.id_,'['..suohib_Msg[math.random(#suohib_Msg)]..']') 
return false
end
...
if text and text:match("^(.*)$") then
if database:get(bot_id.."botss:suohib:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_) == "true" then
send(msg.chat_id_, msg.id_, '\n • ارسل لي الكلمه الان')
database:set(bot_id.."botss:suohib:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_, "true1")
database:set(bot_id.."botss:suohib:Text:Sudo:Bot"..msg.sender_user_id_..":"..msg.chat_id_, text)
database:sadd(bot_id.."botss:suohib:List:Rd:Sudo", text)
return false end
end
if text and text:match("^(.*)$") then
if database:get(bot_id.."botss:suohib:Set:On"..msg.sender_user_id_..":"..msg.chat_id_) == "true" then
send(msg.chat_id_, msg.id_,"• تم حذف الرد من الردود المتعدده")
database:del(bot_id..'botss:suohib:Add:Rd:Sudo:Text'..text)
database:del(bot_id..'botss:suohib:Add:Rd:Sudo:Text1'..text)
database:del(bot_id..'botss:suohib:Add:Rd:Sudo:Text2'..text)
database:del(bot_id.."botss:suohib:Set:On"..msg.sender_user_id_..":"..msg.chat_id_)
database:srem(bot_id.."botss:suohib:List:Rd:Sudo", text)
return false
end
end
if text == ("مسح الردود المتعدده") and SudoBot(msg) then 
local list = database:smembers(bot_id.."botss:suohib:List:Rd:Sudo")
for k,v in pairs(list) do  
database:del(bot_id.."botss:suohib:Add:Rd:Sudo:Text"..v) 
database:del(bot_id.."botss:suohib:Add:Rd:Sudo:Text1"..v) 
database:del(bot_id.."botss:suohib:Add:Rd:Sudo:Text2"..v)   
database:del(bot_id.."botss:suohib:List:Rd:Sudo")
end
...
database:set(bot_id.."botss:suohib:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_,true)
return send(msg.chat_id_, msg.id_,"\n •  حسنآ ارسل الرد الذي تريد\n•  اضافتة يمكنك اضافـة\n•  3 ردود علئ رد واحد\n")
end
if text == "حذف رد متعدد" and SudoBot(msg) then 
database:set(bot_id.."botss:suohib:Set:On"..msg.sender_user_id_..":"..msg.chat_id_,true)
return send(msg.chat_id_, msg.id_,"•  ارسل الان الكلمه لحذفها")
end
if text then  
local test = database:get(bot_id.."botss:suohib:Text:Sudo:Bot"..msg.sender_user_id_..":"..msg.chat_id_)
if database:get(bot_id.."botss:suohib:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_) == "true1" then
database:set(bot_id.."botss:suohib:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_,'rd1')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("","") 
text = text:gsub("*","") 
database:set(bot_id.."botss:suohib:Add:Rd:Sudo:Text"..test, text)  
end  
...
if text then  
local test = database:get(bot_id.."botss:suohib:Text:Sudo:Bot"..msg.sender_user_id_..":"..msg.chat_id_)
if database:get(bot_id.."botss:suohib:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_) == "rd1" then
database:set(bot_id.."botss:suohib:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_,'rd2')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("","") 
text = text:gsub("*","") 
database:set(bot_id.."botss:suohib:Add:Rd:Sudo:Text1"..test, text)  
end  
...
if text then  
local test = database:get(bot_id.."botss:suohib:Text:Sudo:Bot"..msg.sender_user_id_..":"..msg.chat_id_)
if database:get(bot_id.."botss:suohib:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_) == "rd2" then
database:set(bot_id.."botss:suohib:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_,'rd3')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
database:set(bot_id.."botss:suohib:Add:Rd:Sudo:Text2"..test, text)  
end
...
if text then
local Text = database:get(bot_id.."botss:suohib:Add:Rd:Sudo:Text"..text)   
local Text1 = database:get(bot_id.."botss:suohib:Add:Rd:Sudo:Text1"..text)   
local Text2 = database:get(bot_id.."botss:suohib:Add:Rd:Sudo:Text2"..text)   
...
if text == ""..(database:get(bot_id..'Name:Bot') or 'المحترفر').." غادر" or text == 'بوت غادر' then  
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n• العضو > ['..data.first_name_..'](t.me/'..(data.username_ or 'suohib')..') '
...
Text = ' • عدد جهاتك > ['..Num..'](https://t.me/suoyak) •'
end
send(msg.chat_id_, msg.id_,Text) 
end
...
-- vardump(data) 
suohibdx(msg.chat_id_, msg.id_, '• ايدي المجموعة > ( '..msg.chat_id_..' )\n عدد الادمنيه > ( *'..data.administrator_count_..' )*\n• عدد المحظورين > ( *'..data.kicked_count_..' )*\n• عدد الاعضاء > ( *'..data.member_count_..' )*\n', 'md') 
end 
...
لعبة رياضيات >> رياضيات
 ...
 لعبة بات >> بات
•━━━━━━• 
- Ch [𝐩𝐫𝐨f𝐞𝐬𝐬𝐢𝐨𝐧𝐚𝐥 - SoUrCe](https://t.me/suoyak)
]]
...
suohib = https.request("https://api.telegram.org/bot"..token.."/kickChatMember?chat_id="..msg.chat_id_.."&user_id="..mem_id[i].id_)
local Json_Info = JSON.decode(suohib)
...
redis:del(bot_id..'suohib:Link_Group'..Chat_id) 
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه', callback_data="/homeaddrem"},
...
redis:del(bot_id..'suohib:Chek:Welcome'..Chat_id)
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه', callback_data="/homeaddrem"},
...
redis:set(bot_id..'suohib:Reply:Sudo'..Chat_id,true)   
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه', callback_data="/homeaddrem"},
...
redis:set(bot_id..'suohib:Lock:Id:Photo'..Chat_id,true) 
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه', callback_data="/homeaddrem"},
...
redis:set(bot_id..'suohib:Lock:Id:Py:Photo'..Chat_id,true) 
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه', callback_data="/homeaddrem"},
...
redis:set(bot_id..'suohib:Lock:Ban:Group'..Chat_id,'true')
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه', callback_data="/homeaddrem"},
...
redis:set(bot_id..'suohib:Chesuohib:Seted'..Chat_id,'true')
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه', callback_data="/homeaddrem"},
...
redis:set(bot_id..'suohib:Chesuohib:Kick:Me:Group'..Chat_id,true)  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه', callback_data="/homeaddrem"},
...
redis:del(bot_id..'suohib:Lock:Game:Group'..Chat_id)  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه', callback_data="/homeaddrem"},
...
redis:set(bot_id..'suohib:Reply:Manager'..Chat_id,true)  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه', callback_data="/homeaddrem"},
...
redis:set(bot_id..'suohib:Link_Group'..Chat_id,true) 
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه', callback_data="/homeaddrem"},
...
redis:set(bot_id..'suohib:Chek:Welcome'..Chat_id,true) 
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه', callback_data="/homeaddrem"},
...
redis:del(bot_id..'suohib:Reply:Sudo'..Chat_id)  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه', callback_data="/homeaddrem"},
...
redis:del(bot_id..'suohib:Lock:Id:Photo'..Chat_id) 
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه', callback_data="/homeaddrem"},
...
redis:del(bot_id..'suohib:Lock:Id:Py:Photo'..Chat_id)  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه', callback_data="/homeaddrem"},
...
redis:del(bot_id..'suohib:Lock:Ban:Group'..Chat_id)
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه', callback_data="/homeaddrem"},
...
redis:del(bot_id..'suohib:Chesuohib:Seted'..Chat_id)
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه', callback_data="/homeaddrem"},
...
redis:del(bot_id..'suohib:Chesuohib:Kick:Me:Group'..Chat_id)  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه', callback_data="/homeaddrem"},
...
redis:set(bot_id..'suohib:Lock:Game:Group'..Chat_id,true) 
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه', callback_data="/homeaddrem"},
...
redis:del(bot_id..'suohib:Reply:Manager'..Chat_id)  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه', callback_data="/homeaddrem"},
...
redis:set(bot_id.."suohib:Lock:AddMempar"..Chat_id,"kick")  
keyboard = {} 
keyboard.inline_keyboard = {
{
...
redis:set(bot_id.."suohib:Lock:text"..Chat_id,true) 
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه', callback_data="/homelocks"},
...
redis:set(bot_id.."suohib:Lock:Join"..Chat_id,"kick")  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه', callback_data="/homelocks"},
...
redis:set(bot_id.."suohib:Lock:Bot:kick"..Chat_id,"del")  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه', callback_data="/homelocks"},
...
redis:set(bot_id.."suohib:Lock:tagservr"..Chat_id,true)  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه', callback_data="/homelocks"},
...
redis:set(bot_id.."suohib:Lock:edit"..Chat_id,true) 
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه', callback_data="/homelocks"},
...
redis:set(bot_id.."suohib:Lock:Link"..Chat_id,"del")  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه', callback_data="/homelocks"},
...
redis:set(bot_id.."suohib:Lock:User:Name"..Chat_id,"del")  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه', callback_data="/homelocks"},
...
redis:set(bot_id.."suohib:Lock:hashtak"..Chat_id,"del")  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه', callback_data="/homelocks"},
...
redis:set(bot_id.."suohib:Lock:Sticker"..Chat_id,'del')  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه', callback_data="/homelocks"},
...
redis:set(bot_id.."suohib:Lock:Animation"..Chat_id,'del')  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه', callback_data="/homelocks"},
...
redis:set(bot_id.."suohib:Lock:Video"..Chat_id,'del')  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه', callback_data="/homelocks"},
...
redis:set(bot_id.."suohib:Lock:Photo"..Chat_id,'del')  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه', callback_data="/homelocks"},
...
redis:set(bot_id.."suohib:Lock:Audio"..Chat_id,'del')  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه', callback_data="/homelocks"},
...
redis:set(bot_id.."suohib:Lock:vico"..Chat_id,'del')  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه', callback_data="/homelocks"},
...
redis:set(bot_id.."suohib:Lock:forward"..Chat_id,'del')  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه', callback_data="/homelocks"},
...
redis:set(bot_id.."suohib:Lock:Document"..Chat_id,'del')  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه', callback_data="/homelocks"},
...
redis:set(bot_id.."suohib:Lock:Contact"..Chat_id,'del')  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه', callback_data="/homelocks"},
...
redis:set(bot_id.."suohib:Lock:Spam"..Chat_id,'del')  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه', callback_data="/homelocks"},
...
redis:hset(bot_id.."suohib:Spam:Group:User"..Chat_id ,"Spam:User",'del')  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه', callback_data="/homelocks"},
...
redis:set(bot_id.."suohib:Lock:Inlen"..Chat_id,"del")  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه', callback_data="/homelocks"},
...
redis:del(bot_id.."suohib:Lock:AddMempar"..Chat_id)
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه', callback_data="/homelocks"},
...
redis:del(bot_id.."suohib:Lock:text"..Chat_id) 
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه', callback_data="/homelocks"},
...
redis:del(bot_id.."suohib:Lock:Join"..Chat_id)  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه', callback_data="/homelocks"},
...
redis:del(bot_id.."suohib:Lock:Bot:kick"..Chat_id)  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه', callback_data="/homelocks"},
...
redis:del(bot_id.."suohib:Lock:tagservr"..Chat_id)  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه', callback_data="/homelocks"},
...
redis:del(bot_id.."suohib:Lock:edit"..Chat_id)
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه', callback_data="/homelocks"},
...
redis:del(bot_id.."suohib:Lock:Link"..Chat_id)
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه', callback_data="/homelocks"},
...
redis:del(bot_id.."suohib:Lock:User:Name"..Chat_id)  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه', callback_data="/homelocks"},
...
redis:del(bot_id.."suohib:Lock:hashtak"..Chat_id)  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه', callback_data="/homelocks"},
...
redis:del(bot_id.."suohib:Lock:Sticker"..Chat_id)  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه', callback_data="/homelocks"},
...
redis:del(bot_id.."suohib:Lock:Animation"..Chat_id)  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه', callback_data="/homelocks"},
...
redis:del(bot_id.."suohib:Lock:Video"..Chat_id)  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه', callback_data="/homelocks"},
...
redis:del(bot_id.."suohib:Lock:Photo"..Chat_id)  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه', callback_data="/homelocks"},
...
redis:del(bot_id.."suohib:Lock:Audio"..Chat_id)  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه', callback_data="/homelocks"},
...
redis:del(bot_id.."suohib:Lock:vico"..Chat_id)  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه', callback_data="/homelocks"},
...
redis:del(bot_id.."suohib:Lock:forward"..Chat_id)  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه', callback_data="/homelocks"},
...
redis:del(bot_id.."suohib:Lock:Document"..Chat_id)  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه', callback_data="/homelocks"},
...
redis:del(bot_id.."suohib:Lock:Contact"..Chat_id)  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه', callback_data="/homelocks"},
...
redis:del(bot_id.."suohib:Lock:Spam"..Chat_id) 
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه', callback_data="/homelocks"},
...
redis:hdel(bot_id.."suohib:Spam:Group:User"..Chat_id ,"Spam:User")  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه', callback_data="/homelocks"},
...
redis:del(bot_id.."suohib:Lock:Inlen"..Chat_id)  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه', callback_data="/homelocks"},
...
--------------------------------------------------------------------------------------------------------------
Sourcesuohib(data.message_,data)
...
------------------------------------------------------------------------
local suohibAbot = database:get(bot_id.."suohib1:Add:Filter:Rp2"..text..result.chat_id_)   
if suohibAbot then    
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
...
------------------------------------------------------------------------
if text then
local suohib1_Msg = database:get(bot_id.."suohib1:Add:Filter:Rp2"..text..result.chat_id_)   
if suohib1_Msg then    
send(msg.chat_id_, msg.id_,"•"..suohib1_Msg)
